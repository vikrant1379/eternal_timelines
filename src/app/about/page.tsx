    ...
    <div className="min-h-screen academic-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 max-w-3xl mx-auto serif-text leading-relaxed font-medium">
        ...
        <div className="mission-card mb-12 py-12 px-8 text-center rounded-[10px]">
          ...
          <p className="text-xl max-w-4xl mx-auto leading-relaxed serif-text text-gray-800 dark:text-gray-100 font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {values.map((value) => (
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-200 serif-text leading-relaxed font-medium">{value.description}</p>
            </div>
          ))}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {team.map((member) => (
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-200 serif-text leading-relaxed font-medium">{member.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="academic-card p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-400 to-amber-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg transition-colors duration-200"></div>
              ...
              <p className="text-gray-700 dark:text-gray-200 serif-text leading-relaxed font-medium">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg transition-colors duration-200"></div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg transition-colors duration-200"></div>
          ...
          <div className="space-y-8">
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-amber-200 dark:border-amber-600/30 pb-6 last:border-b-0">
                <h3 className="text-xl font-bold text-gray-900 dark:text-amber-100 mb-4 serif-text" style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
                  {faq.question}
                </h3>
                <p className="text-gray-700 dark:text-gray-200 serif-text leading-relaxed text-base font-medium">{faq.answer}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-200 mb-8 serif-text leading-relaxed font-medium">
